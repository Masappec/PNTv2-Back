...
class UserEstablishmentService:
    ...
    def assign_user(self, user_id: int, establishment_id: int):
        try:
            ...
            raise ValueError(f"El usuario o el establecimiento no existen: {e}")
        except Exception as e:
            raise ValueError(f"Error al asignar usuario al establecimiento: {e}")
    ...
    def get_user_by_establishment(self, establishment_id: int):
        try:
            ...
            raise ValueError(f"Error al obtener usuarios por establecimiento: {e}")
    ...
    def get_establishment_by_user(self, user_id: int):
        try:
            ...
            raise ValueError(f"Error al obtener establecimientos por usuario: {e}")
    ...
    def remove_user(self, user_id: int, establishment_id: int):
        try:
            ...
            raise ValueError(f"Error al eliminar usuario del establecimiento: {e}")
    ...
    def remove_all_users(self, establishment_id: int):
        try:
            ...
            raise ValueError(f"Error al eliminar usuarios del establecimiento: {e}")
