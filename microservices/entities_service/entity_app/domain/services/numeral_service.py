...
class NumeralService:
    ...
    def get_transparency_by_numeral(self, numeral, month, year):
        return self.numeral_repository.get_transparency_by_numeral(numeral, month, year)
    
    def create_transparency(self, establishment_id, numeral_id, files, month, year, fecha_actual):
        return self.numeral_repository.create_transparency(establishment_id, numeral_id, files, month, year, fecha_actual)
