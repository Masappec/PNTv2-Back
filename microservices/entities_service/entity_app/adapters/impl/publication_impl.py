...
class PublicationImpl(PublicationRepository):
    ...
    def inactivate_activate_publication(self, publication_id: int,user_id:int):
        ...
        pub = Publication.objects.get(id=publication_id, establishment_id=user_es.establishment.id)
    ...
    def get_publication_detail_admin(self, publication_id: int,user_id:int):
        ...
        user_es = UserEstablishmentExtended.objects.get(user_id=user_id)
        publication = Publication.objects.get(id=publication_id, establishment_id=user_es.establishment.id)
    ...
    def get_publication_by_slug(self, slug: str):
        ...
        publication = Publication.objects.filter(slug=slug, is_active=True).filter( Q(type_publication__code='TA') | Q(type_publication__code='TC')).first()
    ...
    def create_publication(self, publicacion: dict):
        ...
        attachment_instancias = Attachment.objects.filter(id__in=publicacion['attachment'])
