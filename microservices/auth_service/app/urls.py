...
from app.application.views.auth import LoginApiView, RegisterApiView, ActivateAccountApiView, ChangePasswordView
...
urlpatterns = [
    ...
    path("role/list/avaliable", RoleListAvaliable.as_view(),
         name="role-list-avalible"),
